...
void _Underworld_XDMFGenerator_GenerateAll( void* _context ) {
   ...
   if(context->rank == MASTER) {
      ...
      /** other process send information about swarms/swarmvariables to MASTER **/
      //_Underworld_XDMFGenerator_SendSwarmSchema( context );
   }
...
Journal_Printf( stream, "                  <DataItem Format=\"HDF\" %s Dimensions=\"%u 2\">%s.%05d.h5:/%s-Position</DataItem>\n", variableType, swarmParticleLocalCount, currentSwarm->name, context->timeStep, currentSwarm->name );
...
Journal_Printf( stream, "            <DataItem Format=\"HDF\" %s Dimensions=\"%u 3\">%s.%05d.h5:/%s-Position</DataItem>\n", variableType, swarmParticleLocalCount, currentSwarm->name, context->timeStep, currentSwarm->name );
         } else {
...
Journal_Printf( stream, "            <DataItem Format=\"HDF\" %s Dimensions=\"%u 1\">%s.%05d.h5:/%s</DataItem>\n", variableType, swarmParticleLocalCount, currentSwarm->name, context->timeStep, swarmVar->name);
...
Journal_Printf( stream, "                  <DataItem Dimensions=\"3 2\" Format=\"XML\"> 0 0 1 1 %u 1 </DataItem>\n", swarmParticleLocalCount );
Journal_Printf( stream, "                  <DataItem Format=\"HDF\" %s Dimensions=\"%u 2\">%s.%05d.h5:/%s</DataItem>\n", variableType, swarmParticleLocalCount, currentSwarm->name, context->timeStep, swarmVar->name);
Journal_Printf( stream, "               </DataItem>\n" );
...
Journal_Printf( stream, "         </Attribute>\n\n" );
                  ...
                  /** in 3d we simply feed back the 3d hdf5 array, nice and easy **/
Journal_Printf( stream, "         <Attribute Type=\"Vector\" Center=\"Node\" Name=\"%s\">\n", swarmVar->name);
Journal_Printf( stream, "            <DataItem Format=\"HDF\" %s Dimensions=\"%u 3\">%s.%05d.h5:/%s</DataItem>\n", variableType, swarmParticleLocalCount, currentSwarm->name, context->timeStep, swarmVar->name);
Journal_Printf( stream, "         </Attribute>\n\n" );
               } else {
...
Journal_Printf( stream, "               <DataItem Format=\"HDF\" %s Dimensions=\"%u %u\">%s.%05d.h5:/%s</DataItem>\n", variableType, swarmParticleLocalCount, swarmVar->dofCount, currentSwarm->name, context->timeStep, swarmVar->name);
Journal_Printf( stream, "            </DataItem>\n" );
Journal_Printf( stream, "         </Attribute>\n" );
                  }
