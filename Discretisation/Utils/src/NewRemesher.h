...
#ifndef __StGermain_Discretisation_Utils_NewRemesher_h__
#define __StGermain_Discretisation_Utils_NewRemesher_h__
...
#endif /* __StGermain_Discretisation_Utils_NewRemesher_h__ */
