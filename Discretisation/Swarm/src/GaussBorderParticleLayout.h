...
#ifndef __Discretisation_Swarm_GaussBorderParticleLayout_h__
#define __Discretisation_Swarm_GaussBorderParticleLayout_h__
...
#endif /* __Discretisation_Swarm_GaussBorderParticleLayout_h__ */
